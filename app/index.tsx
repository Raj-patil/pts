...
export default function LoginScreen() {
    ...
    const handleLogin = async () => {
        ...
        console.log('Target API:', `${API_URL}/login`);
        ...
        try {
            ...
            if (error.response) {
                ...
                console.error('No response received (Network Error). Check if server is running.');
            } else {
                console.error('Error Message:', error.message);
            }
            alert(`Login Error: ${error.message || 'Login failed'}`);
        } finally {
            setLoading(false);
        }
    };
